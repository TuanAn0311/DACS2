        ...
        <div class="row">
            ...
            <div class="col-6">
                <form action="" method="post"  id="registerForm">
                    ...
                    <div class="row text-light fs-5 mb-4"><h5>Vui lòng đăng ký để tiếp tục</h5></div>
                    <div class="row mb-1">
                        <div class="input-group d-flex align-items-center justify-content-center">
                            ...
                            <div class="icon">&#160<i class="bi bi-person-circle">&ensp;</i></div>
                        </div>
                    ...
                    <div class="row mb-1">
                        <div class="input-group d-flex align-items-center justify-content-center">
                            ...
                            <div class="icon">&#160<i class="bi bi-envelope-at">&ensp;</i></div>
                        </div>
                    ...
                    <div class="row mb-1">
                        <div class="input-group d-flex align-items-center justify-content-center">
                            ...
                            <div class="icon">&#160<i class="bi bi-people-fill">&ensp;</i></div>
                        </div>
                    ...
                    <div class="row mb-4">
                        <div class="input-group d-flex align-items-center justify-content-center">
                            ...
                            <div class="icon">&#160<i class="bi bi-lock-fill">&ensp;</i></div>
                        </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-3">
                            <label class="d-inline-block bor" id="borFree">
                                <input type="radio" name="choose" id="freelancer" value="nha_tuyen_dung" onchange="baoLoiVaiTro()" <?php echo (isset($_SESSION['form_data']['choose']) && $_SESSION['form_data']['choose'] == 'nha_tuyen_dung') ? 'checked' : ''; ?>> 
                                <br>Tôi là nhà tuyển dụng
                            </label>
                        </div>
                        <div class="col-3">
                            <label class="d-inline-block bor" id="borEmploy">
                                <input type="radio" name="choose" id="employer" value="nguoi_tim_viec" onchange="baoLoiVaiTro()" <?php echo (isset($_SESSION['form_data']['choose']) && $_SESSION['form_data']['choose'] == 'nguoi_tim_viec') ? 'checked' : ''; ?>> 
